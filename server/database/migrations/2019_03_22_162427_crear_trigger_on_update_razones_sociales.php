...
class CrearTriggerOnUpdateRazonesSociales extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::unprepared('CREATE TRIGGER update_razones_sociales BEFORE UPDATE ON `razones_sociales`
                        FOR EACH ROW
                        BEGIN
    ...
    {
        DB::unprepared('DROP TRIGGER update_razones_sociales;');
    }
}
